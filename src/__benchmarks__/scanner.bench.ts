...
describe('stripComments', () => {
  ...
  bench('100 lines', () => { stripComments(file100); });
  bench('500 lines', () => { stripComments(file500); });
  bench('1000 lines', () => { stripComments(file1000); });
  bench('5000 lines', () => { stripComments(file5000); });
});
...
describe('scanImports', () => {
  ...
  bench('3 imports', () => { scanImports(few); });
  bench('20 mixed imports', () => { scanImports(twenty); });
  bench('50 mixed imports', () => { scanImports(fifty); });
});
